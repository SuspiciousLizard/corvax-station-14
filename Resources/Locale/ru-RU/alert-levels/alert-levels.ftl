...
alert-level-goyda = Гойда
alert-level-goyda-announcement = Станция находится под угрозой неминуемого порабощения. Членам экипажа рекомендуется бежать и прятаться
alert-level-goyda-instructions = Экипаж должен сохранять спокойствие и ожидать прибытия отряда Древних Русов
